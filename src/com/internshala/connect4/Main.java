...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        menuBar.prefWidthProperty().bind(primaryStage.widthProperty()); // extend menu to the entire width
    ...
    public MenuBar createMenu() {
        ...
        // Reset Game and New Game has the same function.
        // It only resets game, does not remove user entered player names
        ...
        SeparatorMenuItem separatorFileMenuItem = new SeparatorMenuItem();
        MenuItem exitGame = new MenuItem("Exit Game");
        exitGame.setOnAction(event -> exitGame());

        fileMenu.getItems().addAll(newGame, resetGame, separatorFileMenuItem, exitGame);
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Prerna Angrish");
        alert.setContentText("You already know me.");
        alert.show();
    }
